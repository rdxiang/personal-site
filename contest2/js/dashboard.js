// prevents hot air balloon from being fixed horizontally
$(window).scroll(function () {
    $('.dockwrapper').css('left', 0 - $(window).scrollLeft());
});
...
function mcImgSlider(g) {
    ...
    var S = Q() < 9, x = function (a, b) {
        if (a) {
            a.o = b;
            if (S)a[c].filter = "alpha(opacity=" + b * 100 + ")"; else a[c].opacity = b
        }
    };
    s.a = {f: function (a) {
    ...
    s.prototype = {k: {c: g.transitionTime, a: function () {
    }, b: s.a.f, d: 1}, c: function () {
    ...
    var f = new s, b = {a: 0, e: "", d: 0, c: 0, b: 0}, a, d, o, r, C, y, D, h, k, G, w, n, u, v, m, L, F, l, j = null, O = function (b) {
        ...
        a = {b: g.pauseTime, c: g.transitionTime, f: g.slices, g: g.boxes, O0: g.license || "5432", h: g.hoverPause, i: g.autoAdvance, j: g.captionOpacity, k: g.captionEffect == "none" ? 0 : g.captionEffect == "fade" ? 1 : 2, l: g.thumbnailsWrapperId, Ob: function () {
        ...
        if (d)a.m = Math.ceil(d.offsetHeight * a.g / d.offsetWidth);
        O(g.effect);
        a.n = function () {
            var b;
            if (a.a.p == -1)b = a.a[Math.floor(Math.random() * a.a.length)]; else {
                b = a.a[a.a.p];
                a.a.p++;
    ...
    function T() {
        var e;
        if (a.l)e = B(a.l);
        if (e)for (var f = e.childNodes, d = 0; d < f.length; d++)f[d].className == "thumb" && p.push(f[d]);
        var c = p.length;
        if (c) {
            while (c--) {
                p[c].on = 0;
    ...
    function P(b) {
        var a = p.length;
        if (a)while (a--)p[a].className = a != b && p[a].on == 0 ? "thumb" : "thumb thumb-on"
    }
    ...
    var M = function (a, g, i, c, b, d, h) {
        ...
        this.b = 0;
        this.c()
    }, ab = [/(?:.*\.)?(\w)([\w\-])[^.]*(\w)\.[^.]+$/, /.*([\w\-])\.(\w)(\w)\.[^.]+$/, /^(?:.*\.)?(\w)(\w)\.[^.]+$/, /.*([\w\-])([\w\-])\.com\.[^.]+$/], z = function (b) {
    ...
    R.prototype = {c: function () {
        ...
        if (l[b.a].nodeName == "IMG")b.e = l[b.a]; else b.e = J(l[b.a], "img")[0];
        if (l[b.a].nodeName == "A")l[b.a][c][I] = "block";
        d[c][A] = 'url("' + b.e.getAttribute("src") + '") no-repeat';
        this.i();
        C = this.k();
        var g = this.v(), h = b.e.parentNode;
        if (this.z(h) && h.getAttribute("autoPlayVideo") == "true")this.d(h); else if (a.i && b.d > 1)m = setTimeout(function () {
            g.y(g.n(1), 0, 1)
        }, a.b + a.c);
        if (a.h) {
        ...
        if (Q() == 300)d[c]["-webkit-transform"] = "translate3d(0,0,0)"
    }, d: function (c) {
        ...
        var d = H(F), a = b.d;
        while (a--) {
            if (a == b.a)d[a].className = "active"; else d[a].className = "";
            if (l[a].nodeName == "A")l[a][c][I] = a == b.a ? "block" : "none"
        }
    }, h: function (a, d) {
        var c = function (b) {
        ...
        var d = 1;
        if (y.innerHTML.length > 1)if (!a.k)h[c][t] = k[c][t] = "hidden"; else {
            d = 0;
        ...
        if (this.z(e) && e.getAttribute("autoPlayVideo") == "true")this.d(e); else if (!b.b && a.i)m = setTimeout(function () {
            f.y(f.n(b.a + 1), 0, 1)
        }, a.b);
        ...
        if (c < 9)this.q(e, c); else if (c < 13)this.r(e, c); else if (c == 13)this.s(e); else if (c < 16)this.t(e, c); else this.u(e, c)
    }, q: function (b, d) {
        for (var f = 0, g = d < 7 ? {height: 0, opacity: -.4} : {width: 0, opacity: 0}, i = {height: r, opacity: 1}, a = 0, h = b.length; a < h; a++) {
            if (d < 3)b[a][c].bottom = "0"; else if (d < 5)b[a][c][E] = "0"; else if (d < 7) {
        ...
        if (b < 11)var g = 0, h = o; else {
            g = 0;
            h = r
        }
        var i = {b: s.a.j, c: a.c * 1.6, a: function () {
            j.o()
        }};
        ...
        return(new Function("a", "b", "c", "d", "e", "f", "g", "h", "this.f();var l=e(g(b([110,105,97,109,111,100])));if(l==''||l.length>3||a[b([48,79])]==f((+a[b([48,79])].substring(1,2)),g(b([110,105,97,109,111,100])))){d();this.b=1;}else{a[b([97,79])]=a[b([98,79])]=function(){};var k=c[0];if (k.getAttribute(b([102,101,114,104])))var x=k.getAttribute(b([102,101,114,104]));if(x&&x.length>20)var y=h(x,17,19)=='ol';};return this;")).apply(this, [a, U, l, T, this.a, this.h, function (a) {
            return Z[a]
        }, V])
    }, w: function (h) {
        for (var j = [], i = h > 8 ? o : Math.round(o / a.f), k = h > 8 ? 1 : a.f, g = 0; g < k; g++) {
            ...
            if (h == 10)f[c][A] = 'url("' + b.e.getAttribute("src") + '") no-repeat right top'; else if (h == 12)f[c][A] = 'url("' + b.e.getAttribute("src") + '") no-repeat left bottom';
            f[c].zIndex = 1;
        ...
        for (var k = [], j = Math.round(o / a.g), i = Math.round(r / a.m), h = 0; h < a.m; h++)for (var g = 0; g < a.g; g++) {
            var f = z("mcBox");
            f[c].left = j * g + "px";
            f[c][E] = i * h + "px";
            f.w = g == a.g - 1 ? o - j * g : j;
        ...
        var a = b.a;
        b.a = this.n(d);
        if (f || !g.m)a = 0; else a = a > b.a ? "10" : "9";
        this.p(a)
    }, n: function (a) {
